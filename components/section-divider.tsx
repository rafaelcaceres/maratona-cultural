...
const SECTION_INFO: Record<Section, { label: string; color: string }> = {
  principal: { label: "Programação Principal", color: "bg-festival-terracotta" },
  eventos_parceiros: { label: "Eventos Parceiros", color: "bg-festival-gold" },
  programacao_off: { label: "Programação Off", color: "bg-festival-stone" },
};
